...
export class Emitter<
  ...
  ReservedEvents extends EventsMap = {}
> {
  private _callbacks: Record<string, ((...args: any[]) => void)[]> = {};
  ...
  on<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(
    ...
    this._callbacks['$' + ev].push(listener);
    return this;
  }
  ...
  once<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(
    ...
    function on(this: Emitter<ListenEvents, EmitEvents, ReservedEvents>, ...args: any[]) {
      this.off(ev, on);
  ...
  off<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(
    ...
    const callbacks = this._callbacks['$' + ev];
